...
class PolyU(data.Dataset):
    def __init__(self, root='./data/RGB/PolyU-Real-World-Noisy-Images-Dataset/CroppedImages', ext='.JPG',
    ...
    def _scan_files(self, filedir, ext):
        ...
        noisy_samles = sorted([x for x in samples if x.endswith('_real.JPG')])
        gt_samles = sorted([x for x in samples if x.endswith('_mean.JPG')])
